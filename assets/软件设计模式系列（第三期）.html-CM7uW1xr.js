import{_ as s}from"./14-7-DlV-rMmW.js";import{_ as a}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as i,a as e,o as l}from"./app-BXGiKr6t.js";const p="/lmxxf-notes/images/arch/designmodel/16-1.jpg",r="/lmxxf-notes/images/arch/designmodel/16-2.jpg",d="/lmxxf-notes/images/arch/designmodel/16-3.jpg",c="/lmxxf-notes/images/arch/designmodel/16-4.jpg",t="/lmxxf-notes/images/arch/designmodel/16-5.jpg",o="/lmxxf-notes/images/arch/designmodel/16-6.jpg",v="/lmxxf-notes/images/arch/designmodel/16-7.jpg",u={};function m(b,n){return l(),i("div",null,n[0]||(n[0]=[e('<h1 id="软件设计模式系列-第三期" tabindex="-1"><a class="header-anchor" href="#软件设计模式系列-第三期"><span>软件设计模式系列（第三期）</span></a></h1><blockquote><p>作者：老马<br><br>公众号：老马啸西风<br><br> 博客：<a href="https://houbb.github.io/" target="_blank" rel="noopener noreferrer">https://houbb.github.io/</a><br><br> 人生理念：知行合一</p></blockquote><p>面对复杂的业务场景，千变万化的客户需求，如何以一变应万变，以最小的开发成本快速落地实现，同时保证系统有着较低的复杂度，能够保证系统后续de持续迭代能力，让系统拥有较高的可扩展性。</p><p><code>这些是一个合格的架构师必须修炼的基础内功，但是如何修炼这门神功？？？</code></p><p>我将常用的软件设计模式，做了汇总，目录如下：</p><div align="left"><img src="'+s+'" width="400px"></div><p>(考虑到内容篇幅较大，为了便于大家阅读，将软件设计模式系列（共23个）拆分成四篇文章，每篇文章讲解六个设计模式，采用不同的颜色区分，便于快速消化记忆）</p><p><strong>前文回顾：</strong></p><ul><li><a href="https://mp.weixin.qq.com/s/cCPCWCpsJ0VceBQUIMuHPg" target="_blank" rel="noopener noreferrer">面对复杂业务架构，阿里架构师是如何做的？（第一期）</a></li><li><a href="https://mp.weixin.qq.com/s/P-W-FwqtXLkDjjKJYi9HjQ" target="_blank" rel="noopener noreferrer">代码写的烂，经常被同事怼，教你一招！(第二期)</a></li></ul><p>本文是第三期，主要讲解<code>模板模式</code>、<code>策略模式</code>、<code>状态模式</code>、<code>观察者模式</code>、<code>访问者模式</code>、<code>备忘录模式</code></p><h2 id="_1、模板模式" tabindex="-1"><a class="header-anchor" href="#_1、模板模式"><span>1、模板模式</span></a></h2><p><strong>定义：</strong></p><blockquote><p>定义一个操作中的算法的骨架，将一些步骤延迟到子类中。模板模式使得子类可以不改变一个算法的结构即可重定义该算法的某些特定步骤。</p></blockquote><p>优点： 1、封装不变部分，扩展可变部分。 2、提取公共代码，便于维护。 3、行为由父类控制，子类实现。缺点：每一个不同的实现都需要一个子类来实现，导致类的个数增加，维护成本高。</p><p><strong>核心思路：</strong></p><ul><li>AbstractTemplate：定义一个完整的框架，方法的调用顺序已经确定，但会定义一些抽象的方法留给子类去实现</li><li>AHandler：具体的业务子类，实现<code>AbstractTemplate</code>中定义的抽象方法，从而形成一个完整的流程逻辑</li></ul><div align="left"><img src="'+p+`" width="600px"></div><p><strong>代码示例：</strong></p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>public TradeFlowActionResult execute(TradeFlowActionParam param, Map context) throws ServiceException {</span></span>
